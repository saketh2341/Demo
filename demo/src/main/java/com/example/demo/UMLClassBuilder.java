...
public class UMLClassBuilder {
	...
	public UMLClassBuilder(ClassOrInterfaceDeclaration classOrInterface, List<ClassOrInterfaceDeclaration> classOrInterfaceDeclarations,CompilationUnit compilationUnit) {
		this.classOrInterface = classOrInterface;
		this.classOrInterfaceDeclarations = classOrInterfaceDeclarations;
...
//		System.out.println(classOrInterface.getNameAsString());
	...
	private void setFields() {
		...
		for(FieldDeclaration field:fields) {
			System.out.println("this is fieild  "+field);
		}
...
//			
//			System.out.println("this is method  "+method.getBegin().get().line);
//		}
